    ...
    channelCollector.on("collect", async msg => {
      ...
      if (!channel) {
        await msg.channel.send(
          "Bu geçerli bir kanal değil bu yüzden embed oluşturma iptal edildi."
        );
        ...
        msg.channel.send(
          new Discord.MessageEmbed()
            ...
            .setDescription(
              `Embed ${channel.toString()} kanalında paylaşılacak. Embed başlığı ne olsun?`
            )
            .setColor("RANDOM")
        );
        channelCollector.stop();
      ...
      titleCollector.on("collect", async msg => {
        ...
        if (!title) {
          await msg.channel.send(
            `Başlık belirtmedin bu yüzden embed oluşturmayı iptal ettim.`
          );
          ...
          if (msg.content.toLowerCase() === "iptal") {
            ...
            msg.channel.send(
              new Discord.MessageEmbed()
                ...
                .setDescription(
                  `Embed renigini ${duration} olarak ayarladım, Açıklama ne olsun?`
                )
            );
            durationCollector.stop();
          }
              ...
              if (!prize) {
                ...
                msg.channel.send(
                  new Discord.MessageEmbed()
                    ...
                    .setDescription(
                      `Güzel AltBilgi! Zaman damgası(timestamp) ister misin? İstiyorsan \`evet\` istemiyorsan, \`hayır\` yaz.`
                    )
                );
                prizeCollector.stop();
              }
                ...
                if (msg.content.toLowerCase() === "evet") {
                  await msg.channel.send(
                    new Discord.MessageEmbed()
                      ...
                      .setTitle(`Başarılı!`)
                      .setDescription(
                        `Zaman damgası ayarlandı. Embed ${channel.toString()} kanalına gönderildi.`
                      )
                  );
                  timeCollector.stop();
                  ...
                  msg.channel.send(
                    new Discord.MessageEmbed()
                      ...
                      .setTitle("Başarılı!")
                      .setDescription(
                        `Zaman damgası oluşturulmadı. Embed ${channel.toString()} kanalına gönderildi.`
                      )
                  );
